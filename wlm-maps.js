...
function setMarker(feature,latlng) {
    ...
    popuptext = popuptext + '<tr><td colspan=2 style="text-align: center;font-size: 150%;"><iframe src="http://www.mapillary.com/jsapi?showMap=false&showImage=true&image=wrvWcdSvQ_jW-B5Nsuum2w"/></td></tr>';
